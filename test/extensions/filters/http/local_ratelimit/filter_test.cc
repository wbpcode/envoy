...
public:
  DescriptorFilterTest() {
    ...
    {
      RateLimit::Descriptor descriptor1;
      descriptor1.entries_ = {{"hello", "world"}, {"foo", "bar"}};
      RateLimit::Descriptor descriptor2;
      descriptor2.entries_ = {{"foo2", "bar2"}};

      descriptor_first_match_.push_back(descriptor1);
      descriptor_first_match_.push_back(descriptor2);
    }

    {
      RateLimit::Descriptor descriptor;
      descriptor.entries_ = {{"foo", "bar"}};
      descriptor_not_found_.push_back(descriptor);
    }
  }
  ...
  std::vector<RateLimit::Descriptor> descriptor_;
  std::vector<RateLimit::Descriptor> descriptor_first_match_;
  std::vector<RateLimit::Descriptor> descriptor_not_found_;
