...
TEST_P(ProtoApiScrubberIntegrationTest, UnaryRequestPassesThrough) {
  ...
  // Verify Stats
  test_server_->waitForCounter("http.config_test.proto_api_scrubber.total_requests_checked", Ge(1));
}
...
TEST_P(ProtoApiScrubberIntegrationTest, RejectsMethodNotInDescriptor) {
  ...
  test_server_->waitForCounter("http.config_test.proto_api_scrubber.request_scrubbing_failed",
                               Ge(1));
}
...
TEST_P(ProtoApiScrubberIntegrationTest, RejectsInvalidPathFormat) {
  ...
  test_server_->waitForCounter("http.config_test.proto_api_scrubber.invalid_method_name", Ge(1));
}
...
TEST_P(ProtoApiScrubberIntegrationTest, RejectsBlockedMethod) {
  ...
  *restriction.mutable_method_restriction()->mutable_matcher() = matcher;
  ...
  test_server_->waitForCounter("http.config_test.proto_api_scrubber.method_blocked", Ge(1));
}
