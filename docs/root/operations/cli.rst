...
.. option:: --enable-stats-element-scope
  ...
  *(optional)* This flag enables the elements API of stats scopes. When enabled, all default stats tags extraction rules
  and :ref:`stats_tags <envoy_v3_api_field_config.metrics.v3.StatsConfig.stats_tags>` configured in the
  bootstrap configuration will be ignored. All stats tags will be specified in the code when creating the stats.
