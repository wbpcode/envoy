...
template <class FormatterContext>
using CommandParserBaseSharedPtr = std::shared_ptr<CommandParserBase<FormatterContext>>;

template <class FormatterContext>
using CommandParsersBase = std::vector<CommandParserBaseSharedPtr<FormatterContext>>;
...
public:
   ...
   */
  virtual CommandParserBaseSharedPtr<FormatterContext>
...
public:
  static void addCommandParser(CommandParserBaseSharedPtr<FormatterContext> parser) {
...
template <class FormatterContext> struct BuiltInCommandPaserRegister {
  BuiltInCommandPaserRegister(CommandParserBaseSharedPtr<FormatterContext> parser) {
    BuiltInCommandParsersBase<FormatterContext>::addCommandParser(parser);
  }
};
