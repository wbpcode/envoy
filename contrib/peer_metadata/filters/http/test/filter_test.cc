...
protected:
  ...
  void initialize(const std::string& yaml_config) {
    ...
    Http::FilterFactoryCb cb = factory.createFilterFactoryFromProtoTyped(config_, "", context_);
  ...
  envoy::extensions::filters::http::peer_metadata::v3alpha::PeerMetadataConfig config_;
