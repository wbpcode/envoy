...
#include "envoy/extensions/filters/http/peer_metadata/v3alpha/peer_metadata.pb.h"

#include "source/common/singleton/const_singleton.h"
#include "source/extensions/filters/common/expr/cel_state.h"
#include "source/extensions/filters/http/common/pass_through_filter.h"

#include "contrib/common/metadata_object/source/metadata_object.h"
...
public:
  MXPropagationMethod(bool downstream, Server::Configuration::ServerFactoryContext& factory_context,
                      ...
                      const envoy::extensions::filters::http::peer_metadata::v3alpha::
                          PeerMetadataConfig_IstioHeaders&);
...
public:
  FilterConfig(const envoy::extensions::filters::http::peer_metadata::v3alpha::PeerMetadataConfig&,
...
private:
  std::vector<DiscoveryMethodPtr> buildDiscoveryMethods(
      const Protobuf::RepeatedPtrField<envoy::extensions::filters::http::peer_metadata::v3alpha::
                                           PeerMetadataConfig::DiscoveryMethod>&,
  ...
  std::vector<PropagationMethodPtr> buildPropagationMethods(
      const Protobuf::RepeatedPtrField<envoy::extensions::filters::http::peer_metadata::v3alpha::
                                           PeerMetadataConfig::PropagationMethod>&,
      const absl::flat_hash_set<std::string>& additional_labels, bool downstream,
      Server::Configuration::FactoryContext&) const;
