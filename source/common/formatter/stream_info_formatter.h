...
class PlainStringFormatterProvider : public FormatterProviderBase<FormatterContext> {
public:
 ...
 */
template <class FormatterContext>
class PlainNumberFormatterProvider : public FormatterProviderBase<FormatterContext> {
public:
 ...
 */
template <class FormatterContext> class StreamInfoFormatter : public FormatterProvider {
public:
