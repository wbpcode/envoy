...
class UpstreamCodecFilterFactory
    : public Extensions::HttpFilters::Common::ExceptionFreeUpstreamFactoryBase<
          envoy::extensions::filters::http::upstream_codec::v3::UpstreamCodec> {
public:
  UpstreamCodecFilterFactory()
      : ExceptionFreeUpstreamFactoryBase("envoy.filters.http.upstream_codec") {}
