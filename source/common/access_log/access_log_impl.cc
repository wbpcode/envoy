...
bool TraceableRequestFilter::evaluate(const HttpLogContext&,
...
bool StatusCodeFilter::evaluate(const HttpLogContext&, const StreamInfo::StreamInfo& info) const {
...
bool DurationFilter::evaluate(const HttpLogContext&, const StreamInfo::StreamInfo& info) const {
...
bool RuntimeFilter::evaluate(const HttpLogContext&,
...
bool OrFilter::evaluate(const HttpLogContext& context, const StreamInfo::StreamInfo& info) const {
  bool result = false;
...
bool AndFilter::evaluate(const HttpLogContext& context, const StreamInfo::StreamInfo& info) const {
  bool result = true;
  for (auto& filter : filters_) {
    result &= filter->evaluate(context, info);
...
bool NotHealthCheckFilter::evaluate(const HttpLogContext&,
                                    const StreamInfo::StreamInfo& info) const {
...
bool HeaderFilter::evaluate(const HttpLogContext& context, const StreamInfo::StreamInfo&) const {
...
bool ResponseFlagFilter::evaluate(const HttpLogContext&, const StreamInfo::StreamInfo& info) const {
...
bool GrpcStatusFilter::evaluate(const HttpLogContext& context,
                                const StreamInfo::StreamInfo& info) const {
...
bool LogTypeFilter::evaluate(const HttpLogContext& context, const StreamInfo::StreamInfo&) const {
...
bool MetadataFilter::evaluate(const HttpLogContext&, const StreamInfo::StreamInfo& info) const {
  const auto& value =
...
InstanceSharedPtr makeAccessLogInstance(const envoy::config::accesslog::v3::AccessLog& config,
  ...
  auto& factory = Config::Utility::getAndCheckFactory<AccessLogInstanceFactory>(config);
