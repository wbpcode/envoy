...
void Context::log(const AccessLog::HttpLogContext& context,
  ...
  access_log_request_headers_ = &context.requestHeaders();
  // ? request_trailers  ?
  access_log_response_headers_ = &context.responseHeaders();
  access_log_response_trailers_ = &context.responseTrailers();
