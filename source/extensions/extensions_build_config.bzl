...
EXTENSIONS = {
    ...
    "simple_example":                                   "//source/extensions/filters/http/simple_example:config",
    "normal_example":                                   "//source/extensions/filters/http/normal_example:config",
    "complex_example":                                   "//source/extensions/filters/http/complex_example:config",
